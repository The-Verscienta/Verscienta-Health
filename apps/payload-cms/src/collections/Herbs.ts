...
export const Herbs: CollectionConfig = {
  ...
  fields: [
    ...
    // Botanical Information (group - non-repeatable component)
    {
      name: 'botanicalInfo',
      type: 'group',
      fields: [
    ...
    // Common Names (array - repeatable component)
    {
      name: 'commonNames',
      type: 'array',
      fields: [
    ...
    // Synonyms (array - repeatable component)
    {
      name: 'synonyms',
      type: 'array',
      admin: {
    ...
    // Native Region (array - repeatable component)
    {
      name: 'nativeRegion',
      type: 'array',
      fields: [
    ...
    // Cultivation (group - non-repeatable component)
    {
      name: 'cultivation',
      type: 'group',
      fields: [
    ...
    // TCM Properties (group - non-repeatable component)
    {
      name: 'tcmProperties',
      type: 'group',
      admin: {
