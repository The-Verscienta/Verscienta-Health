...
export interface FormulaIngredient extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    role: Schema.Attribute.Enumeration<['chief', 'deputy', 'assistant', 'envoy']>
    unit: Schema.Attribute.Enumeration<['g', 'mg', 'oz', 'ml', 'tsp', 'tbsp', 'drops', 'parts']> &
...
export interface GrokRecommendation extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['herb', 'formula', 'modality', 'practitioner', 'lifestyle']>
  }
}
...
export interface HerbCommonName extends Struct.ComponentSchema {
  ...
  attributes: {
    language: Schema.Attribute.Enumeration<['en', 'zh-pinyin', 'zh', 'es', 'native', 'other']> &
      Schema.Attribute.Required
...
export interface HerbCultivation extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    sunlightNeeds: Schema.Attribute.Enumeration<['full_sun', 'partial_shade', 'full_shade']>
...
export interface HerbDrugInteraction extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    interactionType: Schema.Attribute.Enumeration<['major', 'moderate', 'minor']> &
      Schema.Attribute.Required
...
export interface HerbPreparationMethod extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    methodType: Schema.Attribute.Enumeration<
      ['decoction', 'infusion', 'tincture', 'powder', 'poultice', 'extract', 'oil_infusion']
    > &
      Schema.Attribute.Required
...
export interface HerbSafetyInfo extends Struct.ComponentSchema {
  ...
  attributes: {
    allergenicPotential: Schema.Attribute.Enumeration<['none', 'low', 'moderate', 'high']>
    contraindications: Schema.Attribute.RichText
    sideEffects: Schema.Attribute.RichText
    toxicityLevel: Schema.Attribute.Enumeration<['none', 'low', 'moderate', 'high', 'severe']>
...
export interface HerbTcmProperties extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    tcmTemperature: Schema.Attribute.Enumeration<['hot', 'warm', 'neutral', 'cool', 'cold']>
...
export interface PractitionerAddress extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    country: Schema.Attribute.String & Schema.Attribute.DefaultTo<'United States'>
...
export interface PractitionerPricing extends Struct.ComponentSchema {
  ...
  attributes: {
    currency: Schema.Attribute.Enumeration<['USD', 'EUR', 'GBP', 'CAD', 'AUD']> &
...
export interface ValidationIssue extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    resolvedBy: Schema.Attribute.Relation<'oneToOne', 'plugin::users-permissions.user'>
