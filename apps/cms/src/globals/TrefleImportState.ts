...
export const TrefleImportState: GlobalConfig = {
  ...
  fields: [
    {
      ...
      defaultValue: 1,
      admin: {
        description: 'Current page being imported from Trefle API',
      },
    },
    {
      name: 'isComplete',
  ...
  admin: {
    group: 'System',
    description: 'Tracks the progress of importing plant data from Trefle API',
  },
}
