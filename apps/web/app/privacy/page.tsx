...
export default function PrivacyPage() {
  return (
    <div className="container-custom py-12 max-w-4xl">
      <h1 className="text-4xl font-bold font-serif text-earth-900 mb-8">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-gray-700">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p>
                ...
                You may also optionally provide additional profile information.
              </p>
            </div>
            <div>
            ...
            <div>
              <h3 className="font-semibold mb-2">Device and Technical Information</h3>
              <p>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-2">
              Email:{' '}
              <a href="mailto:privacy@verscientahealth.com" className="text-earth-600 hover:text-earth-700">
...
export const metadata = {
  ...
  description: 'Learn how Verscienta Health collects, uses, and protects your personal information.',
}
