...
<div className="space-y-2">
  <div>
    ...
    <Badge variant="tcm" className="ml-2">Warm</Badge>
  </div>
  <div>
    <span className="text-sm text-muted-foreground">Taste:</span>
    <Badge variant="sage" className="ml-2">Sweet</Badge>
    <Badge variant="sage" className="ml-2">Bitter</Badge>
  </div>
  <div>
    <span className="text-sm text-muted-foreground">Meridians:</span>
    <Badge variant="gold" className="ml-2">Liver</Badge>
    <Badge variant="gold" className="ml-2">Kidney</Badge>
  </div>
</div>
```
...
<div className="flex items-center gap-2">
  ...
  <div>
    ...
    <Badge variant="gold" className="text-xs">Verified Practitioner</Badge>
  </div>
</div>
```
