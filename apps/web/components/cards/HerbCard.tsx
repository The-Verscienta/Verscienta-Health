  ...
  return (
    <Link href={`/herbs/${slug}`}>
      <Card className="group h-full overflow-hidden transition-all hover:shadow-lg">
        {/* Featured Image */}
        {featuredImage ? (
          <div className="relative aspect-video w-full overflow-hidden bg-earth-50">
            <OptimizedCardImage
          ...
          <div className="relative aspect-video w-full overflow-hidden bg-earth-50 flex items-center justify-center">
            <Leaf className="h-16 w-16 text-earth-300" />
          </div>
        )}
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <span className="text-xs font-mono text-gray-500">{herbId}</span>
          </div>
