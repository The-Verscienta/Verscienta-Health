...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'editor', 'practitioner', 'herbalist', 'user');
  CREATE TYPE "public"."enum_users_preferences_language" AS ENUM('en', 'es', 'fr', 'zh-CN', 'zh-TW');
  ...
  CREATE TABLE "herbs" (
  	...
  	"botanical_info_trefle_id" numeric,
  	"botanical_info_trefle_slug" varchar,
  	"botanical_info_last_synced_at" timestamp(3) with time zone,
  	...
  	"citations_last_updated" timestamp(3) with time zone,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_herbs_v_version_citations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"pmid" varchar,
  ...
  CREATE TABLE "_herbs_v" (
  	...
  	"version_botanical_info_trefle_id" numeric,
  	"version_botanical_info_trefle_slug" varchar,
  	"version_botanical_info_last_synced_at" timestamp(3) with time zone,
  	...
  	"version_citations_last_updated" timestamp(3) with time zone,
  ...
  CREATE TABLE "formulas_citations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"pmid" varchar,
  ...
  CREATE TABLE "_formulas_v_version_citations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"pmid" varchar,
  ...
  ALTER TABLE "herbs_citations" ADD CONSTRAINT "herbs_citations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."herbs"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_herbs_v_version_citations" ADD CONSTRAINT "_herbs_v_version_citations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_herbs_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "formulas_citations" ADD CONSTRAINT "formulas_citations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."formulas"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_formulas_v_version_citations" ADD CONSTRAINT "_formulas_v_version_citations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_formulas_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "herbs_citations_order_idx" ON "herbs_citations" USING btree ("_order");
  CREATE INDEX "herbs_citations_parent_id_idx" ON "herbs_citations" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "herbs_citations_pmid_idx" ON "herbs_citations" USING btree ("pmid");
  ...
  CREATE INDEX "_herbs_v_version_citations_order_idx" ON "_herbs_v_version_citations" USING btree ("_order");
  CREATE INDEX "_herbs_v_version_citations_parent_id_idx" ON "_herbs_v_version_citations" USING btree ("_parent_id");
  CREATE INDEX "_herbs_v_version_citations_pmid_idx" ON "_herbs_v_version_citations" USING btree ("pmid");
  ...
  CREATE INDEX "formulas_citations_order_idx" ON "formulas_citations" USING btree ("_order");
  CREATE INDEX "formulas_citations_parent_id_idx" ON "formulas_citations" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "formulas_citations_pmid_idx" ON "formulas_citations" USING btree ("pmid");
  ...
  CREATE INDEX "_formulas_v_version_citations_order_idx" ON "_formulas_v_version_citations" USING btree ("_order");
  CREATE INDEX "_formulas_v_version_citations_parent_id_idx" ON "_formulas_v_version_citations" USING btree ("_parent_id");
  CREATE INDEX "_formulas_v_version_citations_pmid_idx" ON "_formulas_v_version_citations" USING btree ("pmid");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "herbs_citations" CASCADE;
  ...
  DROP TABLE "_herbs_v_version_citations" CASCADE;
  ...
  DROP TABLE "formulas_citations" CASCADE;
  ...
  DROP TABLE "_formulas_v_version_citations" CASCADE;
